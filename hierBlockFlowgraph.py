...
class hierBlockFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "hierBlockFlowgraph")
...
def main(top_block_cls=hierBlockFlowgraph, options=None):
