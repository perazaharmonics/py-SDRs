...
import messagePassingFlowgraph_epy_block_0 as epy_block_0  # embedded python block
import messagePassingFlowgraph_epy_block_1 as epy_block_1  # embedded python block



from gnuradio import qtgui

class messagePassingFlowgraph(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "messagepassing", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("messagepassing")
        ...
        self.settings = Qt.QSettings("GNU Radio", "messagePassingFlowgraph")
...
def main(top_block_cls=messagePassingFlowgraph, options=None):
